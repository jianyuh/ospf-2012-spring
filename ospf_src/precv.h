 ...
 * Author: root
 *
 * Created on May 13, 2012, 10:16 AM
 */
...
struct pcap_sf {
	FILE *rfile;
	int (*next_packet_op)(recv_t *, struct pcap_pkthdr *, u_char **);
	int swapped;
	size_t hdrsize;
...
typedef int	(*activate_op_t)(recv_t *);
typedef int	(*can_set_rfmon_op_t)(recv_t *);
typedef int	(*read_op_t)(recv_t *, int cnt, pcap_handler, u_char *);
typedef int	(*inject_op_t)(recv_t *, const void *, size_t);
typedef int	(*setfilter_op_t)(recv_t *, struct bpf_program *);
typedef int	(*setdirection_op_t)(recv_t *, pcap_direction_t);
typedef int	(*set_datalink_op_t)(recv_t *, int);
typedef int	(*getnonblock_op_t)(recv_t *, char *);
typedef int	(*setnonblock_op_t)(recv_t *, int, char *);
typedef int	(*stats_op_t)(recv_t *, struct pcap_stat *);


typedef void	(*cleanup_op_t)(recv_t *);
